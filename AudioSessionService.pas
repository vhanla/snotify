...
begin
  ...
  begin
    ...
    //[TODO] parecido al anterior método según el ejemplo https://msdn.microsoft.com/en-us/library/windows/desktop/dn313168(v=vs.85).aspx
    // pero en el código de ear lo hace distinto, creo que probaré como el del ejemplo
