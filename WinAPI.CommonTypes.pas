...
type
  ...
  // Windows.Foundation.Diagnostics Enums
  ...
  PCausalityTraceLevel = ^CausalityTraceLevel;
  ...
  PCausalitySource = ^CausalitySource;
  ...
  PCausalityRelation = ^CausalityRelation;
  ...
  PCausalitySynchronousWork = ^CausalitySynchronousWork;
  ...
  PLoggingFieldFormat = ^LoggingFieldFormat;




  // Windows.Foundation.Metadata Enums
  ...
  PGCPressureAmount = ^GCPressureAmount;
  ...
  PAttributeTargets = ^AttributeTargets;
  ...
  PCompositionType = ^CompositionType;
  ...
  PThreadingModel = ^ThreadingModel;
  ...
  PMarshalingType = ^MarshalingType;
  ...
  PDeprecationType = ^DeprecationType;
  ...
  PContacts_ContactFieldType = ^Contacts_ContactFieldType;

  // Windows.ApplicationModel.Contacts.ContactSelectionMode
  Contacts_ContactSelectionMode = (
    Contacts = 0,
    Fields = 1
  );
  PContacts_ContactSelectionMode = ^Contacts_ContactSelectionMode;

  // Windows.ApplicationModel.Contacts.ContactEmailKind
  Contacts_ContactEmailKind = (
    Personal = 0,
    Work = 1,
    Other = 2
  );
  PContacts_ContactEmailKind = ^Contacts_ContactEmailKind;

  // Windows.ApplicationModel.Contacts.ContactPhoneKind
  Contacts_ContactPhoneKind = (
    Home = 0,
    Mobile = 1,
    Work = 2,
    Other = 3,
  ...
  PContacts_ContactPhoneKind = ^Contacts_ContactPhoneKind;

  // Windows.ApplicationModel.Contacts.ContactAddressKind
  Contacts_ContactAddressKind = (
    Home = 0,
    Work = 1,
    Other = 2
  );
  PContacts_ContactAddressKind = ^Contacts_ContactAddressKind;

  // Windows.ApplicationModel.Contacts.ContactDateKind
  Contacts_ContactDateKind = (
    Birthday = 0,
    Anniversary = 1,
    Other = 2
  );
  PContacts_ContactDateKind = ^Contacts_ContactDateKind;

  // Windows.ApplicationModel.Contacts.ContactChangeType
  Contacts_ContactChangeType = (
    Created = 0,
    Modified = 1,
    Deleted = 2,
    ChangeTrackingLost = 3
  );
  PContacts_ContactChangeType = ^Contacts_ContactChangeType;

  // Windows.ApplicationModel.Contacts.ContactRelationship
  Contacts_ContactRelationship = (
    Other = 0,
    Spouse = 1,
    Partner = 2,
    Sibling = 3,
  ...
  PContacts_ContactRelationship = ^Contacts_ContactRelationship;

  // Windows.ApplicationModel.Contacts.ContactQueryDesiredFields
  Contacts_ContactQueryDesiredFields = (
    None = 0,
    PhoneNumber = 1,
    EmailAddress = 2,
    PostalAddress = 4
  );
  PContacts_ContactQueryDesiredFields = ^Contacts_ContactQueryDesiredFields;

  // Windows.ApplicationModel.Contacts.ContactQuerySearchFields
  Contacts_ContactQuerySearchFields = (
    None = 0,
    Name = 1,
    Email = 2,
    Phone = 4,
  ...
  PContacts_ContactQuerySearchFields = ^Contacts_ContactQuerySearchFields;

  // Windows.ApplicationModel.Contacts.ContactQuerySearchScope
  Contacts_ContactQuerySearchScope = (
    Local = 0,
    Server = 1
  );
  PContacts_ContactQuerySearchScope = ^Contacts_ContactQuerySearchScope;

  // Windows.ApplicationModel.Contacts.ContactStoreAccessType
  Contacts_ContactStoreAccessType = (
    AppContactsReadWrite = 0,
    AllContactsReadOnly = 1,
    AllContactsReadWrite = 2
  );
  PContacts_ContactStoreAccessType = ^Contacts_ContactStoreAccessType;

  // Windows.ApplicationModel.Contacts.ContactAnnotationStoreAccessType
  Contacts_ContactAnnotationStoreAccessType = (
    AppAnnotationsReadWrite = 0,
    AllAnnotationsReadWrite = 1
  );
  PContacts_ContactAnnotationStoreAccessType = ^Contacts_ContactAnnotationStoreAccessType;

  // Windows.ApplicationModel.Contacts.ContactListOtherAppReadAccess
  Contacts_ContactListOtherAppReadAccess = (
    SystemOnly = 0,
    Limited = 1,
    Full = 2
  );
  PContacts_ContactListOtherAppReadAccess = ^Contacts_ContactListOtherAppReadAccess;

  // Windows.ApplicationModel.Contacts.ContactListOtherAppWriteAccess
  Contacts_ContactListOtherAppWriteAccess = (
    None = 0,
    SystemOnly = 1
  );
  PContacts_ContactListOtherAppWriteAccess = ^Contacts_ContactListOtherAppWriteAccess;

  // Windows.ApplicationModel.Contacts.ContactMatchReasonKind
  Contacts_ContactMatchReasonKind = (
    Name = 0,
    EmailAddress = 1,
    PhoneNumber = 2,
    JobInfo = 3,
  ...
  PContacts_ContactMatchReasonKind = ^Contacts_ContactMatchReasonKind;

  // Windows.ApplicationModel.Contacts.ContactBatchStatus
  Contacts_ContactBatchStatus = (
    Success = 0,
    ServerSearchSyncManagerError = 1,
    ServerSearchUnknownError = 2
  );
  PContacts_ContactBatchStatus = ^Contacts_ContactBatchStatus;

  // Windows.ApplicationModel.Contacts.ContactAnnotationOperations
  Contacts_ContactAnnotationOperations = (
    None = 0,
    ContactProfile = 1,
    Message = 2,
    AudioCall = 4,
  ...
  PContacts_ContactAnnotationOperations = ^Contacts_ContactAnnotationOperations;

  // Windows.ApplicationModel.Contacts.ContactNameOrder
  Contacts_ContactNameOrder = (
    FirstNameLastName = 0,
    LastNameFirstName = 1
  );
  PContacts_ContactNameOrder = ^Contacts_ContactNameOrder;

  // Windows.ApplicationModel.Contacts.ContactListSyncStatus
  Contacts_ContactListSyncStatus = (
    Idle = 0,
    Syncing = 1,
    UpToDate = 2,
    AuthenticationError = 3,
  ...
  PContacts_ContactListSyncStatus = ^Contacts_ContactListSyncStatus;

  // Windows.ApplicationModel.Contacts.ContactCardHeaderKind
  Contacts_ContactCardHeaderKind = (
    Default = 0,
    Basic = 1,
    Enterprise = 2
  );
  PContacts_ContactCardHeaderKind = ^Contacts_ContactCardHeaderKind;

  // Windows.ApplicationModel.Contacts.ContactCardTabKind
  Contacts_ContactCardTabKind = (
    Default = 0,
    Email = 1,
    Messaging = 2,
    Phone = 3,
  ...
  PContacts_ContactCardTabKind = ^Contacts_ContactCardTabKind;

  // Windows.ApplicationModel.Contacts.ContactFieldCategory
  Contacts_ContactFieldCategory = (
    None = 0,
    Home = 1,
    Work = 2,
    Mobile = 3,
  ...
  PContacts_ContactFieldCategory = ^Contacts_ContactFieldCategory;

  // Windows.ApplicationModel.Contacts.Provider.AddContactResult
  Contacts_Provider_AddContactResult = (
    Added = 0,
    AlreadyAdded = 1,
    Unavailable = 2
  );
  PContacts_Provider_AddContactResult = ^Contacts_Provider_AddContactResult;
  ...
  // Windows.ApplicationModel.Sync.SyncScheduleType
  Sync_SyncScheduleType = (
    Manual = 0,
    Periodic = 1,
    AsItemsArrive = 2,
    Adaptive = 3
  );
  PSync_SyncScheduleType = ^Sync_SyncScheduleType;
  ...
  // Windows.ApplicationModel.Resources Enums
  // Windows.ApplicationModel.Resources.Management.IndexedResourceType
  Management_IndexedResourceType = (
    &String = 0,
    Path = 1,
    EmbeddedData = 2
  );
  PManagement_IndexedResourceType = ^Management_IndexedResourceType;



  // Windows.ApplicationModel.Resources Records
  // Windows.ApplicationModel.Resources.Core.ResourceLayoutInfo
  Core_ResourceLayoutInfo = record
  ...
  PCore_ResourceLayoutInfo = ^Core_ResourceLayoutInfo;

  // Windows.ApplicationModel.Resources.Management.ResourceIndexerContract
  Management_ResourceIndexerContract = record
  end;
  PManagement_ResourceIndexerContract = ^Management_ResourceIndexerContract;



  // Windows.ApplicationModel.UserDataAccounts Enums
  // Windows.ApplicationModel.UserDataAccounts.UserDataAccountOtherAppReadAccess
  UserDataAccountOtherAppReadAccess = (
    SystemOnly = 0,
    Full = 1
  );
  PUserDataAccountOtherAppReadAccess = ^UserDataAccountOtherAppReadAccess;
  ...
  PUserDataAccountStoreAccessType = ^UserDataAccountStoreAccessType;
  ...
  PUserDataAccountContentKinds = ^UserDataAccountContentKinds;

  // Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType
  SystemAccess_DeviceAccountServerType = (
    Exchange = 0,
    Pop = 1,
    Imap = 2
  );
  PSystemAccess_DeviceAccountServerType = ^SystemAccess_DeviceAccountServerType;
  ...
  PSms_SmsMessageClass = ^Sms_SmsMessageClass;
  ...
  PSms_SmsMessageType = ^Sms_SmsMessageType;
  ...
  PSms_CellularClass = ^Sms_CellularClass;
  ...
  PSms_SmsDataFormat = ^Sms_SmsDataFormat;
  ...
  PSms_SmsEncoding = ^Sms_SmsEncoding;

  // Windows.Devices.Sms.SmsGeographicalScope
  Sms_SmsGeographicalScope = (
    None = 0,
  ...
  PSms_SmsGeographicalScope = ^Sms_SmsGeographicalScope;

  // Windows.Devices.Sms.SmsBroadcastType
  Sms_SmsBroadcastType = (
    Other = 0,
    CmasPresidential = 1,
    CmasExtreme = 2,
    CmasSevere = 3,
  ...
  PSms_SmsBroadcastType = ^Sms_SmsBroadcastType;
  ...
  PSms_SmsDeviceStatus = ^Sms_SmsDeviceStatus;

  // Windows.Devices.Sms.SmsModemErrorCode
  Sms_SmsModemErrorCode = (
    Other = 0,
  ...
  PSms_SmsModemErrorCode = ^Sms_SmsModemErrorCode;

  // Windows.Devices.Sms.SmsFilterActionType
  Sms_SmsFilterActionType = (
    AcceptImmediately = 0,
    Drop = 1,
    Peek = 2,
    Accept = 3
  );
  PSms_SmsFilterActionType = ^Sms_SmsFilterActionType;

  // Windows.Devices.AllJoyn.AllJoynAuthenticationMechanism
  AllJoyn_AllJoynAuthenticationMechanism = (
    None = 0,
    SrpAnonymous = 1,
    SrpLogon = 2,
    EcdheNull = 3,
  ...
  PAllJoyn_AllJoynAuthenticationMechanism = ^AllJoyn_AllJoynAuthenticationMechanism;

  // Windows.Devices.AllJoyn.AllJoynBusAttachmentState
  AllJoyn_AllJoynBusAttachmentState = (
    Disconnected = 0,
    Connecting = 1,
    Connected = 2,
    Disconnecting = 3
  );
  PAllJoyn_AllJoynBusAttachmentState = ^AllJoyn_AllJoynBusAttachmentState;

  // Windows.Devices.AllJoyn.AllJoynTrafficType
  AllJoyn_AllJoynTrafficType = (
    Unknown = 0,
    Messages = 1,
    RawUnreliable = 2,
    RawReliable = 4
  );
  PAllJoyn_AllJoynTrafficType = ^AllJoyn_AllJoynTrafficType;

  // Windows.Devices.AllJoyn.AllJoynSessionLostReason
  AllJoyn_AllJoynSessionLostReason = (
    None = 0,
  ...
  PAllJoyn_AllJoynSessionLostReason = ^AllJoyn_AllJoynSessionLostReason;

  // Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates
  Geolocation_Geofencing_MonitoredGeofenceStates = (
    None = 0,
    Entered = 1,
    Exited = 2,
    Removed = 4
  );
  PGeolocation_Geofencing_MonitoredGeofenceStates = ^Geolocation_Geofencing_MonitoredGeofenceStates;

  // Windows.Devices.Geolocation.Geofencing.GeofenceState
  Geolocation_Geofencing_GeofenceState = (
    None = 0,
    Entered = 1,
    Exited = 2,
    Removed = 4
  );
  PGeolocation_Geofencing_GeofenceState = ^Geolocation_Geofencing_GeofenceState;

  // Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus
  Geolocation_Geofencing_GeofenceMonitorStatus = (
    Ready = 0,
    Initializing = 1,
    NoData = 2,
    Disabled = 3,
  ...
  PGeolocation_Geofencing_GeofenceMonitorStatus = ^Geolocation_Geofencing_GeofenceMonitorStatus;

  // Windows.Devices.Geolocation.Geofencing.GeofenceRemovalReason
  Geolocation_Geofencing_GeofenceRemovalReason = (
    Used = 0,
    Expired = 1
  );
  PGeolocation_Geofencing_GeofenceRemovalReason = ^Geolocation_Geofencing_GeofenceRemovalReason;

  // Windows.Devices.Geolocation.PositionAccuracy
  Geolocation_PositionAccuracy = (
    Default = 0,
    High = 1
  );
  PGeolocation_PositionAccuracy = ^Geolocation_PositionAccuracy;

  // Windows.Devices.Geolocation.PositionStatus
  Geolocation_PositionStatus = (
    Ready = 0,
    Initializing = 1,
    NoData = 2,
    Disabled = 3,
  ...
  PGeolocation_PositionStatus = ^Geolocation_PositionStatus;

  // Windows.Devices.Geolocation.PositionSource
  Geolocation_PositionSource = (
    Cellular = 0,
    Satellite = 1,
    WiFi = 2,
    IPAddress = 3,
  ...
  PGeolocation_PositionSource = ^Geolocation_PositionSource;

  // Windows.Devices.Geolocation.GeoshapeType
  Geolocation_GeoshapeType = (
    Geopoint = 0,
    Geocircle = 1,
    Geopath = 2,
    GeoboundingBox = 3
  );
  PGeolocation_GeoshapeType = ^Geolocation_GeoshapeType;

  // Windows.Devices.Geolocation.AltitudeReferenceSystem
  Geolocation_AltitudeReferenceSystem = (
    Unspecified = 0,
    Terrain = 1,
    Ellipsoid = 2,
    Geoid = 3,
  ...
  PGeolocation_AltitudeReferenceSystem = ^Geolocation_AltitudeReferenceSystem;

  // Windows.Devices.Geolocation.GeolocationAccessStatus
  Geolocation_GeolocationAccessStatus = (
    Unspecified = 0,
    Allowed = 1,
    Denied = 2
  );
  PGeolocation_GeolocationAccessStatus = ^Geolocation_GeolocationAccessStatus;
  ...
  PMidi_MidiMessageType = ^Midi_MidiMessageType;
  ...
  PointOfService_UnifiedPosErrorSeverity = (
  ...
  PPointOfService_UnifiedPosErrorSeverity = ^PointOfService_UnifiedPosErrorSeverity;

  // Windows.Devices.PointOfService.UnifiedPosPowerReportingType
  PointOfService_UnifiedPosPowerReportingType = (
    UnknownPowerReportingType = 0,
    Standard = 1,
    Advanced = 2
  );
  PPointOfService_UnifiedPosPowerReportingType = ^PointOfService_UnifiedPosPowerReportingType;

  // Windows.Devices.PointOfService.UnifiedPosHealthCheckLevel
  PointOfService_UnifiedPosHealthCheckLevel = (
    UnknownHealthCheckLevel = 0,
    POSInternal = 1,
    External = 2,
    Interactive = 3
  );
  PPointOfService_UnifiedPosHealthCheckLevel = ^PointOfService_UnifiedPosHealthCheckLevel;

  // Windows.Devices.PointOfService.UnifiedPosErrorReason
  PointOfService_UnifiedPosErrorReason = (
  ...
  PPointOfService_UnifiedPosErrorReason = ^PointOfService_UnifiedPosErrorReason;

  // Windows.Devices.PointOfService.MagneticStripeReaderAuthenticationLevel
  PointOfService_MagneticStripeReaderAuthenticationLevel = (
    NotSupported = 0,
    Optional = 1,
    Required = 2
  );
  PPointOfService_MagneticStripeReaderAuthenticationLevel = ^PointOfService_MagneticStripeReaderAuthenticationLevel;

  // Windows.Devices.PointOfService.PosPrinterMapMode
  PointOfService_PosPrinterMapMode = (
    Dots = 0,
    Twips = 1,
    English = 2,
    Metric = 3
  );
  PPointOfService_PosPrinterMapMode = ^PointOfService_PosPrinterMapMode;

  // Windows.Devices.PointOfService.PosPrinterCartridgeSensors
  PointOfService_PosPrinterCartridgeSensors = (
    None = 0,
    Removed = 1,
    Empty = 2,
    HeadCleaning = 4,
  ...
  PPointOfService_PosPrinterCartridgeSensors = ^PointOfService_PosPrinterCartridgeSensors;

  // Windows.Devices.PointOfService.PosPrinterColorCapabilities
  PointOfService_PosPrinterColorCapabilities = (
    None = 0,
    Primary = 1,
    Custom1 = 2,
    Custom2 = 4,
  ...
  PPointOfService_PosPrinterColorCapabilities = ^PointOfService_PosPrinterColorCapabilities;

  // Windows.Devices.PointOfService.PosPrinterColorCartridge
  PointOfService_PosPrinterColorCartridge = (
    Unknown = 0,
    Primary = 1,
    Custom1 = 2,
    Custom2 = 3,
  ...
  PPointOfService_PosPrinterColorCartridge = ^PointOfService_PosPrinterColorCartridge;

  // Windows.Devices.PointOfService.PosPrinterMarkFeedCapabilities
  PointOfService_PosPrinterMarkFeedCapabilities = (
    None = 0,
    ToTakeUp = 1,
    ToCutter = 2,
  ...
  PPointOfService_PosPrinterMarkFeedCapabilities = ^PointOfService_PosPrinterMarkFeedCapabilities;

  // Windows.Devices.PointOfService.PosPrinterRuledLineCapabilities
  PointOfService_PosPrinterRuledLineCapabilities = (
    None = 0,
    Horizontal = 1,
    Vertical = 2
  );
  PPointOfService_PosPrinterRuledLineCapabilities = ^PointOfService_PosPrinterRuledLineCapabilities;

  // Windows.Devices.PointOfService.PosPrinterPrintSide
  PointOfService_PosPrinterPrintSide = (
    Unknown = 0,
    Side1 = 1,
    Side2 = 2
  );
  PPointOfService_PosPrinterPrintSide = ^PointOfService_PosPrinterPrintSide;

  // Windows.Devices.PointOfService.PosPrinterLineDirection
  PointOfService_PosPrinterLineDirection = (
    Horizontal = 0,
    Vertical = 1
  );
  PPointOfService_PosPrinterLineDirection = ^PointOfService_PosPrinterLineDirection;

  // Windows.Devices.PointOfService.PosPrinterLineStyle
  PointOfService_PosPrinterLineStyle = (
    SingleSolid = 0,
    DoubleSolid = 1,
    Broken = 2,
    Chain = 3
  );
  PPointOfService_PosPrinterLineStyle = ^PointOfService_PosPrinterLineStyle;

  // Windows.Devices.PointOfService.PosPrinterMarkFeedKind
  PointOfService_PosPrinterMarkFeedKind = (
    ToTakeUp = 0,
    ToCutter = 1,
    ToCurrentTopOfForm = 2,
    ToNextTopOfForm = 3
  );
  PPointOfService_PosPrinterMarkFeedKind = ^PointOfService_PosPrinterMarkFeedKind;

  // Windows.Devices.PointOfService.PosPrinterAlignment
  PointOfService_PosPrinterAlignment = (
    Left = 0,
    Center = 1,
    Right = 2
  );
  PPointOfService_PosPrinterAlignment = ^PointOfService_PosPrinterAlignment;

  // Windows.Devices.PointOfService.PosPrinterBarcodeTextPosition
  PointOfService_PosPrinterBarcodeTextPosition = (
    None = 0,
    Above = 1,
    Below = 2
  );
  PPointOfService_PosPrinterBarcodeTextPosition = ^PointOfService_PosPrinterBarcodeTextPosition;

  // Windows.Devices.PointOfService.PosPrinterRotation
  PointOfService_PosPrinterRotation = (
    Normal = 0,
    Right90 = 1,
    Left90 = 2,
    Rotate180 = 3
  );
  PPointOfService_PosPrinterRotation = ^PointOfService_PosPrinterRotation;

  // Windows.Devices.PointOfService.PosPrinterStatusKind
  PointOfService_PosPrinterStatusKind = (
    Online = 0,
    Off = 1,
    Offline = 2,
    OffOrOffline = 3,
  ...
  PPointOfService_PosPrinterStatusKind = ^PointOfService_PosPrinterStatusKind;

  // Windows.Devices.PointOfService.CashDrawerStatusKind
  PointOfService_CashDrawerStatusKind = (
    Online = 0,
    Off = 1,
    Offline = 2,
    OffOrOffline = 3,
  ...
  PPointOfService_CashDrawerStatusKind = ^PointOfService_CashDrawerStatusKind;

  // Windows.Devices.PointOfService.BarcodeScannerStatus
  PointOfService_BarcodeScannerStatus = (
    Online = 0,
    Off = 1,
    Offline = 2,
    OffOrOffline = 3,
  ...
  PPointOfService_BarcodeScannerStatus = ^PointOfService_BarcodeScannerStatus;

  // Windows.Devices.PointOfService.MagneticStripeReaderStatus
  PointOfService_MagneticStripeReaderStatus = (
    Unauthenticated = 0,
    Authenticated = 1,
    Extended = 2
  );
  PPointOfService_MagneticStripeReaderStatus = ^PointOfService_MagneticStripeReaderStatus;

  // Windows.Devices.PointOfService.MagneticStripeReaderAuthenticationProtocol
  PointOfService_MagneticStripeReaderAuthenticationProtocol = (
    None = 0,
    ChallengeResponse = 1
  );
  PPointOfService_MagneticStripeReaderAuthenticationProtocol = ^PointOfService_MagneticStripeReaderAuthenticationProtocol;

  // Windows.Devices.PointOfService.MagneticStripeReaderTrackIds
  PointOfService_MagneticStripeReaderTrackIds = (
    None = 0,
    Track1 = 1,
    Track2 = 2,
    Track3 = 4,
  ...
  PPointOfService_MagneticStripeReaderTrackIds = ^PointOfService_MagneticStripeReaderTrackIds;

  // Windows.Devices.PointOfService.MagneticStripeReaderErrorReportingType
  PointOfService_MagneticStripeReaderErrorReportingType = (
    CardLevel = 0,
    TrackLevel = 1
  );
  PPointOfService_MagneticStripeReaderErrorReportingType = ^PointOfService_MagneticStripeReaderErrorReportingType;

  // Windows.Devices.PointOfService.MagneticStripeReaderTrackErrorType
  PointOfService_MagneticStripeReaderTrackErrorType = (
    None = 0,
  ...
  PPointOfService_MagneticStripeReaderTrackErrorType = ^PointOfService_MagneticStripeReaderTrackErrorType;
  ...
  Sensors_MagnetometerAccuracy = (
    Unknown = 0,
    Unreliable = 1,
    Approximate = 2,
    High = 3
  );
  PSensors_MagnetometerAccuracy = ^Sensors_MagnetometerAccuracy;

  // Windows.Devices.Sensors.ActivityType
  Sensors_ActivityType = (
    Unknown = 0,
    Idle = 1,
    Stationary = 2,
    Fidgeting = 3,
  ...
  PSensors_ActivityType = ^Sensors_ActivityType;

  // Windows.Devices.Sensors.ActivitySensorReadingConfidence
  Sensors_ActivitySensorReadingConfidence = (
    High = 0,
    Low = 1
  );
  PSensors_ActivitySensorReadingConfidence = ^Sensors_ActivitySensorReadingConfidence;

  // Windows.Devices.Sensors.SensorReadingType
  Sensors_SensorReadingType = (
    Absolute = 0,
    Relative = 1
  );
  PSensors_SensorReadingType = ^Sensors_SensorReadingType;

  // Windows.Devices.Sensors.SimpleOrientation
  Sensors_SimpleOrientation = (
    NotRotated = 0,
  ...
  PSensors_SimpleOrientation = ^Sensors_SimpleOrientation;

  // Windows.Devices.Sensors.PedometerStepKind
  Sensors_PedometerStepKind = (
    Unknown = 0,
    Walking = 1,
    Running = 2
  );
  PSensors_PedometerStepKind = ^Sensors_PedometerStepKind;
  ...
  PSms_SmsMessageFilter = ^Sms_SmsMessageFilter;
  ...
  PScanners_ImageScannerFormat = ^Scanners_ImageScannerFormat;

  // Windows.Devices.Scanners.ImageScannerAutoCroppingMode
  Scanners_ImageScannerAutoCroppingMode = (
    Disabled = 0,
    SingleRegion = 1,
    MultipleRegion = 2
  );
  PScanners_ImageScannerAutoCroppingMode = ^Scanners_ImageScannerAutoCroppingMode;

  // Windows.Devices.Scanners.ImageScannerColorMode
  Scanners_ImageScannerColorMode = (
    Color = 0,
    Grayscale = 1,
    Monochrome = 2,
    AutoColor = 3
  );
  PScanners_ImageScannerColorMode = ^Scanners_ImageScannerColorMode;

  // Windows.Devices.Scanners.ImageScannerScanSource
  Scanners_ImageScannerScanSource = (
    Default = 0,
    Flatbed = 1,
    Feeder = 2,
    AutoConfigured = 3
  );
  PScanners_ImageScannerScanSource = ^Scanners_ImageScannerScanSource;
  ...
  PSms_SmsEncodedLength = ^Sms_SmsEncodedLength;

  // Windows.Devices.Geolocation.BasicGeoposition
  Geolocation_BasicGeoposition = record
    Latitude: Double;
    Longitude: Double;
    Altitude: Double;
  end;
  PGeolocation_BasicGeoposition = ^Geolocation_BasicGeoposition;
  ...
  Sms_LegacySmsApiContract = record
  end;
  PSms_LegacySmsApiContract = ^Sms_LegacySmsApiContract;
  ...
  Scanners_ScannerDeviceContract = record
  end;
  PScanners_ScannerDeviceContract = ^Scanners_ScannerDeviceContract;

  // Windows.Devices.Scanners.ImageScannerResolution
  Scanners_ImageScannerResolution = record
    DpiX: Single;
    DpiY: Single;
  end;
  PScanners_ImageScannerResolution = ^Scanners_ImageScannerResolution;
  ...
  Advertisement_BluetoothLEScanningMode = (
    Passive = 0,
    Active = 1
  );
  PAdvertisement_BluetoothLEScanningMode = ^Advertisement_BluetoothLEScanningMode;

  // Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags
  Advertisement_BluetoothLEAdvertisementFlags = (
    None = 0,
    LimitedDiscoverableMode = 1,
  ...
  PAdvertisement_BluetoothLEAdvertisementFlags = ^Advertisement_BluetoothLEAdvertisementFlags;

  // Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementType
  Advertisement_BluetoothLEAdvertisementType = (
  ...
  PAdvertisement_BluetoothLEAdvertisementType = ^Advertisement_BluetoothLEAdvertisementType;

  // Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcherStatus
  Advertisement_BluetoothLEAdvertisementWatcherStatus = (
    Created = 0,
    Started = 1,
    Stopping = 2,
    Stopped = 3,
  ...
  PAdvertisement_BluetoothLEAdvertisementWatcherStatus = ^Advertisement_BluetoothLEAdvertisementWatcherStatus;

  // Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisherStatus
  Advertisement_BluetoothLEAdvertisementPublisherStatus = (
    Created = 0,
    Waiting = 1,
    Started = 2,
    Stopping = 3,
  ...
  PAdvertisement_BluetoothLEAdvertisementPublisherStatus = ^Advertisement_BluetoothLEAdvertisementPublisherStatus;
  ...
  // Windows.Graphics.Printing3D.Printing3DObjectUnit
  Printing3D_Printing3DObjectUnit = (
    Meter = 0,
    Micron = 1,
    Millimeter = 2,
    Centimeter = 3,
  ...
  PPrinting3D_Printing3DObjectUnit = ^Printing3D_Printing3DObjectUnit;
  ...
  PDevices_TelephonyKey = ^Devices_TelephonyKey;
  ...
  Devices_AudioDeviceRole = (
    Default = 0,
    Communications = 1
  );
  PDevices_AudioDeviceRole = ^Devices_AudioDeviceRole;
  ...
  // Windows.Media.Preview.Photo.Import.PhotoImportTimestamp
  Preview_Photo_Import_PhotoImportTimestamp = (
    UseDateTaken = 0,
    UseCreationDate = 1
  );
  PPreview_Photo_Import_PhotoImportTimestamp = ^Preview_Photo_Import_PhotoImportTimestamp;

  // Windows.Media.Preview.Photo.Import.PhotoImportImportMode
  Preview_Photo_Import_PhotoImportImportMode = (
    ImportEverything = 0,
    IgnoreSidecars = 1,
    IgnoreSiblings = 2,
    IgnoreSidecarsAndSiblings = 3
  );
  PPreview_Photo_Import_PhotoImportImportMode = ^Preview_Photo_Import_PhotoImportImportMode;

  // Windows.Media.Preview.Photo.Import.PhotoImportDeleteMode
  Preview_Photo_Import_PhotoImportDeleteMode = (
    DeleteEverything = 0,
    IgnoreSidecars = 1,
    IgnoreSiblings = 2,
    IgnoreSidecarsAndSiblings = 3
  );
  PPreview_Photo_Import_PhotoImportDeleteMode = ^Preview_Photo_Import_PhotoImportDeleteMode;

  // Windows.Media.Preview.Photo.Import.PhotoImportSourceType
  Preview_Photo_Import_PhotoImportSourceType = (
    Generic = 0,
    Camera = 1,
    MediaPlayer = 2,
    Phone = 3,
  ...
  PPreview_Photo_Import_PhotoImportSourceType = ^Preview_Photo_Import_PhotoImportSourceType;

  // Windows.Media.Preview.Photo.Import.PhotoImportPowerSource
  Preview_Photo_Import_PhotoImportPowerSource = (
    Unknown = 0,
    Battery = 1,
    ExternalPower = 2
  );
  PPreview_Photo_Import_PhotoImportPowerSource = ^Preview_Photo_Import_PhotoImportPowerSource;

  // Windows.Media.Preview.Photo.Import.PhotoImportOperationState
  Preview_Photo_Import_PhotoImportOperationState = (
    Idle = 0,
  ...
  PPreview_Photo_Import_PhotoImportOperationState = ^Preview_Photo_Import_PhotoImportOperationState;

  // Windows.Media.Preview.Photo.Import.PhotoImportStorageMediumType
  Preview_Photo_Import_PhotoImportStorageMediumType = (
    Undefined = 0,
    Fixed = 1,
    Removable = 2
  );
  PPreview_Photo_Import_PhotoImportStorageMediumType = ^Preview_Photo_Import_PhotoImportStorageMediumType;

  // Windows.Media.Preview.Photo.Import.PhotoImportContentTypeFilter
  Preview_Photo_Import_PhotoImportContentTypeFilter = (
    PhotosOnly = 0,
    VideosOnly = 1,
    PhotosAndVideos = 2
  );
  PPreview_Photo_Import_PhotoImportContentTypeFilter = ^Preview_Photo_Import_PhotoImportContentTypeFilter;

  // Windows.Media.Preview.Photo.Import.PhotoImportAutoSelectionMode
  Preview_Photo_Import_PhotoImportAutoSelectionMode = (
    IgnoreSidecars = 0,
    ConsiderSidecars = 1
  );
  PPreview_Photo_Import_PhotoImportAutoSelectionMode = ^Preview_Photo_Import_PhotoImportAutoSelectionMode;

  // Windows.Media.Preview.Photo.Import.PhotoImportItemSelectionMode
  Preview_Photo_Import_PhotoImportItemSelectionMode = (
    SelectAll = 0,
    SelectNone = 1,
    Automatic = 2,
    AutomaticIgnoringSidecars = 3
  );
  PPreview_Photo_Import_PhotoImportItemSelectionMode = ^Preview_Photo_Import_PhotoImportItemSelectionMode;

  // Windows.Media.Preview.Photo.Import.PhotoImportConnectionTransport
  Preview_Photo_Import_PhotoImportConnectionTransport = (
    Unspecified = 0,
    Usb = 1,
    IP = 2,
    Bluetooth = 3
  );
  PPreview_Photo_Import_PhotoImportConnectionTransport = ^Preview_Photo_Import_PhotoImportConnectionTransport;

  // Windows.Media.Preview.Photo.Import.PhotoImportSubfoldersNamingScheme
  Preview_Photo_Import_PhotoImportSubfoldersNamingScheme = (
    None = 0,
    UsePreferredTimestamp = 1,
    KeepOriginalFolderNames = 2
  );
  PPreview_Photo_Import_PhotoImportSubfoldersNamingScheme = ^Preview_Photo_Import_PhotoImportSubfoldersNamingScheme;

  // Windows.Media.Preview.Photo.Import.PhotoImportStorageAccessCapability
  Preview_Photo_Import_PhotoImportStorageAccessCapability = (
    ReadWrite = 0,
    ReadOnly = 1,
    ReadOnlyWithObjectDeletion = 2
  );
  PPreview_Photo_Import_PhotoImportStorageAccessCapability = ^Preview_Photo_Import_PhotoImportStorageAccessCapability;

  // Windows.Media.Preview.Photo.Import.PhotoImportDestinationFilesNamingScheme
  Preview_Photo_Import_PhotoImportDestinationFilesNamingScheme = (
    KeepOriginalNames = 0,
    UsePerSessionSequentialNumbers = 1
  );
  PPreview_Photo_Import_PhotoImportDestinationFilesNamingScheme = ^Preview_Photo_Import_PhotoImportDestinationFilesNamingScheme;
  ...
  PDevices_IsoSpeedPreset = ^Devices_IsoSpeedPreset;

  // Windows.Media.Devices.CaptureSceneMode
  Devices_CaptureSceneMode = (
    Auto = 0,
    Manual = 1,
    Macro = 2,
    Portrait = 3,
  ...
  PDevices_CaptureSceneMode = ^Devices_CaptureSceneMode;

  // Windows.Media.Devices.MediaCaptureFocusState
  Devices_MediaCaptureFocusState = (
    Uninitialized = 0,
    Lost = 1,
    Searching = 2,
    Focused = 3,
  ...
  PDevices_MediaCaptureFocusState = ^Devices_MediaCaptureFocusState;

  // Windows.Media.Devices.CameraStreamState
  Devices_CameraStreamState = (
    NotStreaming = 0,
    Streaming = 1,
    BlockedForPrivacy = 2,
    Shutdown = 3
  );
  PDevices_CameraStreamState = ^Devices_CameraStreamState;

  // Windows.Media.Devices.MediaCapturePauseBehavior
  Devices_MediaCapturePauseBehavior = (
    RetainHardwareResources = 0,
    ReleaseHardwareResources = 1
  );
  PDevices_MediaCapturePauseBehavior = ^Devices_MediaCapturePauseBehavior;

  // Windows.Media.Devices.AdvancedPhotoMode
  Devices_AdvancedPhotoMode = (
    Auto = 0,
    Standard = 1,
    Hdr = 2
  );
  PDevices_AdvancedPhotoMode = ^Devices_AdvancedPhotoMode;

  // Windows.Media.MediaProperties.MediaPixelFormat
  MediaProperties_MediaPixelFormat = (
    Nv12 = 0,
    Bgra8 = 1
  );
  PMediaProperties_MediaPixelFormat = ^MediaProperties_MediaPixelFormat;

  // Windows.Media.MediaProperties.MediaThumbnailFormat
  MediaProperties_MediaThumbnailFormat = (
    Bmp = 0,
    Bgra8 = 1
  );
  PMediaProperties_MediaThumbnailFormat = ^MediaProperties_MediaThumbnailFormat;

  // Windows.Media.MediaProperties.AudioEncodingQuality
  MediaProperties_AudioEncodingQuality = (
    Auto = 0,
    High = 1,
    Medium = 2,
    Low = 3
  );
  PMediaProperties_AudioEncodingQuality = ^MediaProperties_AudioEncodingQuality;

  // Windows.Media.MediaProperties.VideoEncodingQuality
  MediaProperties_VideoEncodingQuality = (
    Auto = 0,
    HD1080p = 1,
    HD720p = 2,
    Wvga = 3,
  ...
  PMediaProperties_VideoEncodingQuality = ^MediaProperties_VideoEncodingQuality;

  // Windows.Media.MediaProperties.MediaRotation
  MediaProperties_MediaRotation = (
    None = 0,
    Clockwise90Degrees = 1,
    Clockwise180Degrees = 2,
    Clockwise270Degrees = 3
  );
  PMediaProperties_MediaRotation = ^MediaProperties_MediaRotation;

  // Windows.Media.MediaProperties.MediaMirroringOptions
  MediaProperties_MediaMirroringOptions = (
    None = 0,
    Horizontal = 1,
    Vertical = 2
  );
  PMediaProperties_MediaMirroringOptions = ^MediaProperties_MediaMirroringOptions;
  ...
  Devices_ColorTemperaturePreset = (
    Auto = 0,
    Manual = 1,
    Cloudy = 2,
    Daylight = 3,
  ...
  PDevices_ColorTemperaturePreset = ^Devices_ColorTemperaturePreset;

  // Windows.Media.Devices.ZoomTransitionMode
  Devices_ZoomTransitionMode = (
    Auto = 0,
    Direct = 1,
    Smooth = 2
  );
  PDevices_ZoomTransitionMode = ^Devices_ZoomTransitionMode;
  ...
  PDevices_FocusPreset = ^Devices_FocusPreset;
  ...
  PDevices_FocusMode = ^Devices_FocusMode;

  // Windows.Media.Devices.ManualFocusDistance
  Devices_ManualFocusDistance = (
    Infinity = 0,
    Hyperfocal = 1,
    Nearest = 2
  );
  PDevices_ManualFocusDistance = ^Devices_ManualFocusDistance;

  // Windows.Media.Devices.AutoFocusRange
  Devices_AutoFocusRange = (
    FullRange = 0,
    Macro = 1,
    Normal = 2
  );
  PDevices_AutoFocusRange = ^Devices_AutoFocusRange;

  // Windows.Media.Devices.RegionOfInterestType
  Devices_RegionOfInterestType = (
    Unknown = 0,
    Face = 1
  );
  PDevices_RegionOfInterestType = ^Devices_RegionOfInterestType;

  // Windows.Media.Devices.HdrVideoMode
  Devices_HdrVideoMode = (
    Off = 0,
    On = 1,
    Auto = 2
  );
  PDevices_HdrVideoMode = ^Devices_HdrVideoMode;

  // Windows.Media.Devices.OpticalImageStabilizationMode
  Devices_OpticalImageStabilizationMode = (
    Off = 0,
    On = 1,
    Auto = 2
  );
  PDevices_OpticalImageStabilizationMode = ^Devices_OpticalImageStabilizationMode;
  ...
  PDevices_CaptureUse = ^Devices_CaptureUse;

  // Windows.Media.Devices.MediaCaptureOptimization
  Devices_MediaCaptureOptimization = (
    Default = 0,
    Quality = 1,
    Latency = 2,
    Power = 3,
  ...
  PDevices_MediaCaptureOptimization = ^Devices_MediaCaptureOptimization;

  // Windows.Media.Devices.Core.FrameFlashMode
  Devices_Core_FrameFlashMode = (
    Disable = 0,
    Enable = 1,
    Global = 2
  );
  PDevices_Core_FrameFlashMode = ^Devices_Core_FrameFlashMode;
  ...
  Devices_CallControlContract = record
  end;
  PDevices_CallControlContract = ^Devices_CallControlContract;
  ...
  // Windows.Networking.BackgroundTransfer Enums
  ...
  PBackgroundTransferStatus = ^BackgroundTransferStatus;
  ...
  PBackgroundTransferCostPolicy = ^BackgroundTransferCostPolicy;
  ...
  PBackgroundTransferPriority = ^BackgroundTransferPriority;
  ...
  PBackgroundTransferBehavior = ^BackgroundTransferBehavior;



  // Windows.Networking.BackgroundTransfer Records
  // Windows.Networking.BackgroundTransfer.BackgroundDownloadProgress
  BackgroundDownloadProgress = record
  ...
  PBackgroundDownloadProgress = ^BackgroundDownloadProgress;

  // Windows.Networking.BackgroundTransfer.BackgroundUploadProgress
  BackgroundUploadProgress = record
    BytesReceived: UInt64;
    BytesSent: UInt64;
    TotalBytesToReceive: UInt64;
  ...
  PBackgroundUploadProgress = ^BackgroundUploadProgress;
  ...
  // Windows.Networking.ServiceDiscovery.Dnssd Enums
  ...
  PDnssdRegistrationStatus = ^DnssdRegistrationStatus;
  ...
  PDnssdServiceWatcherStatus = ^DnssdServiceWatcherStatus;
  ...
  // Windows.UI.ApplicationSettings Enums
  ...
  PWebAccountAction = ^WebAccountAction;
  ...
  PSupportedWebAccountActions = ^SupportedWebAccountActions;
  ...
  PSettingsEdgeLocation = ^SettingsEdgeLocation;



  // Windows.UI.ApplicationSettings Records
  // Windows.UI.ApplicationSettings.ApplicationsSettingsContract
  ApplicationsSettingsContract = record
  end;
  PApplicationsSettingsContract = ^ApplicationsSettingsContract;
  ...
  PForegroundText = ^ForegroundText;
  ...
  Xaml_Documents_LogicalDirection = (
    Backward = 0,
    Forward = 1
  );
  PXaml_Documents_LogicalDirection = ^Xaml_Documents_LogicalDirection;

  // Windows.UI.Xaml.Documents.UnderlineStyle
  Xaml_Documents_UnderlineStyle = (
    None = 0,
    Single = 1
  );
  PXaml_Documents_UnderlineStyle = ^Xaml_Documents_UnderlineStyle;

  // Windows.UI.Xaml.Controls.CandidateWindowAlignment
  Xaml_Controls_CandidateWindowAlignment = (
    Default = 0,
    BottomEdge = 1
  );
  PXaml_Controls_CandidateWindowAlignment = ^Xaml_Controls_CandidateWindowAlignment;

  // Windows.UI.Xaml.Controls.ClickMode
  Xaml_Controls_ClickMode = (
    Release = 0,
    Press = 1,
    Hover = 2
  );
  PXaml_Controls_ClickMode = ^Xaml_Controls_ClickMode;

  // Windows.UI.Xaml.Controls.IncrementalLoadingTrigger
  Xaml_Controls_IncrementalLoadingTrigger = (
    None = 0,
    Edge = 1
  );
  PXaml_Controls_IncrementalLoadingTrigger = ^Xaml_Controls_IncrementalLoadingTrigger;

  // Windows.UI.Xaml.Controls.ItemsUpdatingScrollMode
  Xaml_Controls_ItemsUpdatingScrollMode = (
    KeepItemsInView = 0,
    KeepScrollOffset = 1
  );
  PXaml_Controls_ItemsUpdatingScrollMode = ^Xaml_Controls_ItemsUpdatingScrollMode;

  // Windows.UI.Xaml.Controls.ListViewReorderMode
  Xaml_Controls_ListViewReorderMode = (
    Disabled = 0,
    Enabled = 1
  );
  PXaml_Controls_ListViewReorderMode = ^Xaml_Controls_ListViewReorderMode;

  // Windows.UI.Xaml.Controls.ListViewSelectionMode
  Xaml_Controls_ListViewSelectionMode = (
    None = 0,
    Single = 1,
    Multiple = 2,
    Extended = 3
  );
  PXaml_Controls_ListViewSelectionMode = ^Xaml_Controls_ListViewSelectionMode;

  // Windows.UI.Xaml.Controls.Orientation
  Xaml_Controls_Orientation = (
    Vertical = 0,
    Horizontal = 1
  );
  PXaml_Controls_Orientation = ^Xaml_Controls_Orientation;

  // Windows.UI.Xaml.Controls.PanelScrollingDirection
  Xaml_Controls_PanelScrollingDirection = (
    None = 0,
    Forward = 1,
    Backward = 2
  );
  PXaml_Controls_PanelScrollingDirection = ^Xaml_Controls_PanelScrollingDirection;

  // Windows.UI.Xaml.Controls.PasswordRevealMode
  Xaml_Controls_PasswordRevealMode = (
    Peek = 0,
    Hidden = 1,
    Visible = 2
  );
  PXaml_Controls_PasswordRevealMode = ^Xaml_Controls_PasswordRevealMode;

  // Windows.UI.Xaml.Controls.ScrollBarVisibility
  Xaml_Controls_ScrollBarVisibility = (
    Disabled = 0,
    Auto = 1,
    Hidden = 2,
    Visible = 3
  );
  PXaml_Controls_ScrollBarVisibility = ^Xaml_Controls_ScrollBarVisibility;

  // Windows.UI.Xaml.Controls.ScrollIntoViewAlignment
  Xaml_Controls_ScrollIntoViewAlignment = (
    Default = 0,
    Leading = 1
  );
  PXaml_Controls_ScrollIntoViewAlignment = ^Xaml_Controls_ScrollIntoViewAlignment;

  // Windows.UI.Xaml.Controls.ScrollMode
  Xaml_Controls_ScrollMode = (
    Disabled = 0,
    Enabled = 1,
    Auto = 2
  );
  PXaml_Controls_ScrollMode = ^Xaml_Controls_ScrollMode;

  // Windows.UI.Xaml.Controls.SelectionMode
  Xaml_Controls_SelectionMode = (
    Single = 0,
    Multiple = 1,
    Extended = 2
  );
  PXaml_Controls_SelectionMode = ^Xaml_Controls_SelectionMode;

  // Windows.UI.Xaml.Controls.SnapPointsType
  Xaml_Controls_SnapPointsType = (
    None = 0,
    Optional = 1,
    Mandatory = 2,
    OptionalSingle = 3,
  ...
  PXaml_Controls_SnapPointsType = ^Xaml_Controls_SnapPointsType;

  // Windows.UI.Xaml.Controls.StretchDirection
  Xaml_Controls_StretchDirection = (
    UpOnly = 0,
    DownOnly = 1,
    Both = 2
  );
  PXaml_Controls_StretchDirection = ^Xaml_Controls_StretchDirection;

  // Windows.UI.Xaml.Controls.VirtualizationMode
  Xaml_Controls_VirtualizationMode = (
    Standard = 0,
    Recycling = 1
  );
  PXaml_Controls_VirtualizationMode = ^Xaml_Controls_VirtualizationMode;

  // Windows.UI.Xaml.Controls.ZoomMode
  Xaml_Controls_ZoomMode = (
    Disabled = 0,
    Enabled = 1
  );
  PXaml_Controls_ZoomMode = ^Xaml_Controls_ZoomMode;

  // Windows.UI.Xaml.Controls.Primitives.GeneratorDirection
  Xaml_Controls_Primitives_GeneratorDirection = (
    Forward = 0,
    Backward = 1
  );
  PXaml_Controls_Primitives_GeneratorDirection = ^Xaml_Controls_Primitives_GeneratorDirection;

  // Windows.UI.Xaml.Controls.Primitives.GroupHeaderPlacement
  Xaml_Controls_Primitives_GroupHeaderPlacement = (
    Top = 0,
    Left = 1
  );
  PXaml_Controls_Primitives_GroupHeaderPlacement = ^Xaml_Controls_Primitives_GroupHeaderPlacement;

  // Windows.UI.Xaml.Controls.Primitives.PlacementMode
  Xaml_Controls_Primitives_PlacementMode = (
    Bottom = 2,
    Left = 9,
    Mouse = 7,
    Right = 4,
  ...
  PXaml_Controls_Primitives_PlacementMode = ^Xaml_Controls_Primitives_PlacementMode;

  // Windows.UI.Xaml.Controls.Primitives.ScrollEventType
  Xaml_Controls_Primitives_ScrollEventType = (
    SmallDecrement = 0,
    SmallIncrement = 1,
    LargeDecrement = 2,
    LargeIncrement = 3,
  ...
  PXaml_Controls_Primitives_ScrollEventType = ^Xaml_Controls_Primitives_ScrollEventType;

  // Windows.UI.Xaml.Controls.Primitives.ScrollingIndicatorMode
  Xaml_Controls_Primitives_ScrollingIndicatorMode = (
    None = 0,
    TouchIndicator = 1,
    MouseIndicator = 2
  );
  PXaml_Controls_Primitives_ScrollingIndicatorMode = ^Xaml_Controls_Primitives_ScrollingIndicatorMode;

  // Windows.UI.Xaml.Controls.Primitives.SliderSnapsTo
  Xaml_Controls_Primitives_SliderSnapsTo = (
    StepValues = 0,
    Ticks = 1
  );
  PXaml_Controls_Primitives_SliderSnapsTo = ^Xaml_Controls_Primitives_SliderSnapsTo;

  // Windows.UI.Xaml.Controls.Primitives.SnapPointsAlignment
  Xaml_Controls_Primitives_SnapPointsAlignment = (
    Near = 0,
    Center = 1,
    Far = 2
  );
  PXaml_Controls_Primitives_SnapPointsAlignment = ^Xaml_Controls_Primitives_SnapPointsAlignment;

  // Windows.UI.Xaml.Controls.Primitives.TickPlacement
  Xaml_Controls_Primitives_TickPlacement = (
    None = 0,
    TopLeft = 1,
    BottomRight = 2,
    Outside = 3,
  ...
  PXaml_Controls_Primitives_TickPlacement = ^Xaml_Controls_Primitives_TickPlacement;

  // Windows.UI.Xaml.Printing.PreviewPageCountType
  Xaml_Printing_PreviewPageCountType = (
    Final = 0,
    Intermediate = 1
  );
  PXaml_Printing_PreviewPageCountType = ^Xaml_Printing_PreviewPageCountType;

  // Windows.UI.Xaml.Navigation.NavigationCacheMode
  Xaml_Navigation_NavigationCacheMode = (
    Disabled = 0,
    Required = 1,
    Enabled = 2
  );
  PXaml_Navigation_NavigationCacheMode = ^Xaml_Navigation_NavigationCacheMode;

  // Windows.UI.Xaml.Navigation.NavigationMode
  Xaml_Navigation_NavigationMode = (
    New = 0,
    Back = 1,
    Forward = 2,
    Refresh = 3
  );
  PXaml_Navigation_NavigationMode = ^Xaml_Navigation_NavigationMode;

  // Windows.UI.Xaml.Interop.NotifyCollectionChangedAction
  Xaml_Interop_NotifyCollectionChangedAction = (
    Add = 0,
    Remove = 1,
    Replace = 2,
    Move = 3,
  ...
  PXaml_Interop_NotifyCollectionChangedAction = ^Xaml_Interop_NotifyCollectionChangedAction;

  // Windows.UI.Xaml.Media.MediaElementState
  Xaml_Media_MediaElementState = (
    Closed = 0,
    Opening = 1,
    Buffering = 2,
    Playing = 3,
  ...
  PXaml_Media_MediaElementState = ^Xaml_Media_MediaElementState;

  // Windows.UI.Xaml.Controls.AppBarClosedDisplayMode
  Xaml_Controls_AppBarClosedDisplayMode = (
    Compact = 0,
    Minimal = 1,
    Hidden = 2
  );
  PXaml_Controls_AppBarClosedDisplayMode = ^Xaml_Controls_AppBarClosedDisplayMode;

  // Windows.UI.Xaml.Controls.AutoSuggestionBoxTextChangeReason
  Xaml_Controls_AutoSuggestionBoxTextChangeReason = (
    UserInput = 0,
    ProgrammaticChange = 1,
    SuggestionChosen = 2
  );
  PXaml_Controls_AutoSuggestionBoxTextChangeReason = ^Xaml_Controls_AutoSuggestionBoxTextChangeReason;

  // Windows.UI.Xaml.Controls.CalendarViewDisplayMode
  Xaml_Controls_CalendarViewDisplayMode = (
    Month = 0,
    Year = 1,
    Decade = 2
  );
  PXaml_Controls_CalendarViewDisplayMode = ^Xaml_Controls_CalendarViewDisplayMode;

  // Windows.UI.Xaml.Controls.CalendarViewSelectionMode
  Xaml_Controls_CalendarViewSelectionMode = (
    None = 0,
    Single = 1,
    Multiple = 2
  );
  PXaml_Controls_CalendarViewSelectionMode = ^Xaml_Controls_CalendarViewSelectionMode;

  // Windows.UI.Xaml.Controls.ContentDialogResult
  Xaml_Controls_ContentDialogResult = (
    None = 0,
    Primary = 1,
    Secondary = 2
  );
  PXaml_Controls_ContentDialogResult = ^Xaml_Controls_ContentDialogResult;

  // Windows.UI.Xaml.Controls.SplitViewDisplayMode
  Xaml_Controls_SplitViewDisplayMode = (
    Overlay = 0,
    &Inline = 1,
    CompactOverlay = 2,
    CompactInline = 3
  );
  PXaml_Controls_SplitViewDisplayMode = ^Xaml_Controls_SplitViewDisplayMode;

  // Windows.UI.Xaml.Controls.SplitViewPanePlacement
  Xaml_Controls_SplitViewPanePlacement = (
    Left = 0,
    Right = 1
  );
  PXaml_Controls_SplitViewPanePlacement = ^Xaml_Controls_SplitViewPanePlacement;

  // Windows.UI.Xaml.Controls.Symbol
  Xaml_Controls_Symbol = (
    Previous = 57600,
    Next = 57601,
    Play = 57602,
    Pause = 57603,
  ...
  PXaml_Controls_Symbol = ^Xaml_Controls_Symbol;

  // Windows.UI.Xaml.Controls.WebViewExecutionMode
  Xaml_Controls_WebViewExecutionMode = (
    SameThread = 0,
    SeparateThread = 1
  );
  PXaml_Controls_WebViewExecutionMode = ^Xaml_Controls_WebViewExecutionMode;

  // Windows.UI.Xaml.Controls.WebViewPermissionState
  Xaml_Controls_WebViewPermissionState = (
    Unknown = 0,
    Defer = 1,
    Allow = 2,
    Deny = 3
  );
  PXaml_Controls_WebViewPermissionState = ^Xaml_Controls_WebViewPermissionState;

  // Windows.UI.Xaml.Controls.WebViewPermissionType
  Xaml_Controls_WebViewPermissionType = (
    Geolocation = 0,
    UnlimitedIndexedDBQuota = 1,
    Media = 2
  );
  PXaml_Controls_WebViewPermissionType = ^Xaml_Controls_WebViewPermissionType;

  // Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenterCheckMode
  Xaml_Controls_Primitives_ListViewItemPresenterCheckMode = (
    &Inline = 0,
    Overlay = 1
  );
  PXaml_Controls_Primitives_ListViewItemPresenterCheckMode = ^Xaml_Controls_Primitives_ListViewItemPresenterCheckMode;

  // Windows.UI.Xaml.ApplicationTheme
  Xaml_ApplicationTheme = (
    Light = 0,
    Dark = 1
  );
  PXaml_ApplicationTheme = ^Xaml_ApplicationTheme;
  ...
  PXaml_DurationType = ^Xaml_DurationType;
  ...
  PXaml_ElementTheme = ^Xaml_ElementTheme;
  ...
  PXaml_FlowDirection = ^Xaml_FlowDirection;
  ...
  PXaml_FocusState = ^Xaml_FocusState;
  ...
  PXaml_FontCapitals = ^Xaml_FontCapitals;

  // Windows.UI.Xaml.FontEastAsianLanguage
  Xaml_FontEastAsianLanguage = (
    Normal = 0,
    HojoKanji = 1,
    Jis04 = 2,
    Jis78 = 3,
  ...
  PXaml_FontEastAsianLanguage = ^Xaml_FontEastAsianLanguage;

  // Windows.UI.Xaml.FontEastAsianWidths
  Xaml_FontEastAsianWidths = (
    Normal = 0,
    Full = 1,
    Half = 2,
    Proportional = 3,
  ...
  PXaml_FontEastAsianWidths = ^Xaml_FontEastAsianWidths;
  ...
  PXaml_FontFraction = ^Xaml_FontFraction;

  // Windows.UI.Xaml.FontNumeralAlignment
  Xaml_FontNumeralAlignment = (
    Normal = 0,
    Proportional = 1,
    Tabular = 2
  );
  PXaml_FontNumeralAlignment = ^Xaml_FontNumeralAlignment;

  // Windows.UI.Xaml.FontNumeralStyle
  Xaml_FontNumeralStyle = (
    Normal = 0,
    Lining = 1,
    OldStyle = 2
  );
  PXaml_FontNumeralStyle = ^Xaml_FontNumeralStyle;
  ...
  PXaml_FontVariants = ^Xaml_FontVariants;
  ...
  PXaml_GridUnitType = ^Xaml_GridUnitType;

  // Windows.UI.Xaml.HorizontalAlignment
  Xaml_HorizontalAlignment = (
    Left = 0,
    Center = 1,
    Right = 2,
    Stretch = 3
  );
  PXaml_HorizontalAlignment = ^Xaml_HorizontalAlignment;

  // Windows.UI.Xaml.LineStackingStrategy
  Xaml_LineStackingStrategy = (
    MaxHeight = 0,
    BlockLineHeight = 1,
    BaselineToBaseline = 2
  );
  PXaml_LineStackingStrategy = ^Xaml_LineStackingStrategy;

  // Windows.UI.Xaml.OpticalMarginAlignment
  Xaml_OpticalMarginAlignment = (
    None = 0,
    TrimSideBearings = 1
  );
  PXaml_OpticalMarginAlignment = ^Xaml_OpticalMarginAlignment;
  ...
  PXaml_TextAlignment = ^Xaml_TextAlignment;
  ...
  PXaml_TextLineBounds = ^Xaml_TextLineBounds;

  // Windows.UI.Xaml.TextReadingOrder
  Xaml_TextReadingOrder = (
    Default = 0,
    UseFlowDirection = 0,
    DetectFromContent = 1
  );
  PXaml_TextReadingOrder = ^Xaml_TextReadingOrder;
  ...
  PXaml_TextTrimming = ^Xaml_TextTrimming;
  ...
  PXaml_TextWrapping = ^Xaml_TextWrapping;

  // Windows.UI.Xaml.VerticalAlignment
  Xaml_VerticalAlignment = (
    Top = 0,
    Center = 1,
    Bottom = 2,
    Stretch = 3
  );
  PXaml_VerticalAlignment = ^Xaml_VerticalAlignment;
  ...
  PXaml_Visibility = ^Xaml_Visibility;

  // Windows.UI.Xaml.Media.AlignmentX
  Xaml_Media_AlignmentX = (
    Left = 0,
    Center = 1,
    Right = 2
  );
  PXaml_Media_AlignmentX = ^Xaml_Media_AlignmentX;

  // Windows.UI.Xaml.Media.AlignmentY
  Xaml_Media_AlignmentY = (
    Top = 0,
    Center = 1,
    Bottom = 2
  );
  PXaml_Media_AlignmentY = ^Xaml_Media_AlignmentY;

  // Windows.UI.Xaml.Media.AudioCategory
  Xaml_Media_AudioCategory = (
    Other = 0,
    ForegroundOnlyMedia = 1,
    BackgroundCapableMedia = 2,
    Communications = 3,
  ...
  PXaml_Media_AudioCategory = ^Xaml_Media_AudioCategory;

  // Windows.UI.Xaml.Media.AudioDeviceType
  Xaml_Media_AudioDeviceType = (
    Console = 0,
    Multimedia = 1,
    Communications = 2
  );
  PXaml_Media_AudioDeviceType = ^Xaml_Media_AudioDeviceType;

  // Windows.UI.Xaml.Media.BrushMappingMode
  Xaml_Media_BrushMappingMode = (
    Absolute = 0,
    RelativeToBoundingBox = 1
  );
  PXaml_Media_BrushMappingMode = ^Xaml_Media_BrushMappingMode;

  // Windows.UI.Xaml.Media.ColorInterpolationMode
  Xaml_Media_ColorInterpolationMode = (
    ScRgbLinearInterpolation = 0,
    SRgbLinearInterpolation = 1
  );
  PXaml_Media_ColorInterpolationMode = ^Xaml_Media_ColorInterpolationMode;

  // Windows.UI.Xaml.Media.ElementCompositeMode
  Xaml_Media_ElementCompositeMode = (
    Inherit = 0,
    SourceOver = 1,
    MinBlend = 2
  );
  PXaml_Media_ElementCompositeMode = ^Xaml_Media_ElementCompositeMode;
  ...
  PXaml_Media_FillRule = ^Xaml_Media_FillRule;

  // Windows.UI.Xaml.Media.GradientSpreadMethod
  Xaml_Media_GradientSpreadMethod = (
    Pad = 0,
    Reflect = 1,
    &Repeat = 2
  );
  PXaml_Media_GradientSpreadMethod = ^Xaml_Media_GradientSpreadMethod;

  // Windows.UI.Xaml.Media.MediaCanPlayResponse
  Xaml_Media_MediaCanPlayResponse = (
    NotSupported = 0,
    Maybe = 1,
    Probably = 2
  );
  PXaml_Media_MediaCanPlayResponse = ^Xaml_Media_MediaCanPlayResponse;

  // Windows.UI.Xaml.Media.PenLineCap
  Xaml_Media_PenLineCap = (
    Flat = 0,
    Square = 1,
    Round = 2,
    Triangle = 3
  );
  PXaml_Media_PenLineCap = ^Xaml_Media_PenLineCap;

  // Windows.UI.Xaml.Media.PenLineJoin
  Xaml_Media_PenLineJoin = (
    Miter = 0,
    Bevel = 1,
    Round = 2
  );
  PXaml_Media_PenLineJoin = ^Xaml_Media_PenLineJoin;

  // Windows.UI.Xaml.Media.Stereo3DVideoPackingMode
  Xaml_Media_Stereo3DVideoPackingMode = (
    None = 0,
    SideBySide = 1,
    TopBottom = 2
  );
  PXaml_Media_Stereo3DVideoPackingMode = ^Xaml_Media_Stereo3DVideoPackingMode;

  // Windows.UI.Xaml.Media.Stereo3DVideoRenderMode
  Xaml_Media_Stereo3DVideoRenderMode = (
    Mono = 0,
    Stereo = 1
  );
  PXaml_Media_Stereo3DVideoRenderMode = ^Xaml_Media_Stereo3DVideoRenderMode;
  ...
  PXaml_Media_Stretch = ^Xaml_Media_Stretch;

  // Windows.UI.Xaml.Media.StyleSimulations
  Xaml_Media_StyleSimulations = (
    None = 0,
    BoldSimulation = 1,
    ItalicSimulation = 2,
    BoldItalicSimulation = 3
  );
  PXaml_Media_StyleSimulations = ^Xaml_Media_StyleSimulations;

  // Windows.UI.Xaml.Media.SweepDirection
  Xaml_Media_SweepDirection = (
    Counterclockwise = 0,
    Clockwise = 1
  );
  PXaml_Media_SweepDirection = ^Xaml_Media_SweepDirection;

  // Windows.UI.Xaml.Media.Animation.ClockState
  Xaml_Media_Animation_ClockState = (
    Active = 0,
    Filling = 1,
    Stopped = 2
  );
  PXaml_Media_Animation_ClockState = ^Xaml_Media_Animation_ClockState;

  // Windows.UI.Xaml.Media.Animation.EasingMode
  Xaml_Media_Animation_EasingMode = (
    EaseOut = 0,
    EaseIn = 1,
    EaseInOut = 2
  );
  PXaml_Media_Animation_EasingMode = ^Xaml_Media_Animation_EasingMode;

  // Windows.UI.Xaml.Media.Animation.FillBehavior
  Xaml_Media_Animation_FillBehavior = (
    HoldEnd = 0,
    Stop = 1
  );
  PXaml_Media_Animation_FillBehavior = ^Xaml_Media_Animation_FillBehavior;

  // Windows.UI.Xaml.Media.Animation.RepeatBehaviorType
  Xaml_Media_Animation_RepeatBehaviorType = (
    Count = 0,
    Duration = 1,
    Forever = 2
  );
  PXaml_Media_Animation_RepeatBehaviorType = ^Xaml_Media_Animation_RepeatBehaviorType;

  // Windows.UI.Xaml.Input.FocusNavigationDirection
  Xaml_Input_FocusNavigationDirection = (
    Next = 0,
    Previous = 1,
    Up = 2,
    Down = 3,
  ...
  PXaml_Input_FocusNavigationDirection = ^Xaml_Input_FocusNavigationDirection;

  // Windows.UI.Xaml.Input.InputScopeNameValue
  Xaml_Input_InputScopeNameValue = (
    Default = 0,
    Url = 1,
    EmailSmtpAddress = 5,
    PersonalFullName = 7,
  ...
  PXaml_Input_InputScopeNameValue = ^Xaml_Input_InputScopeNameValue;

  // Windows.UI.Xaml.Input.KeyboardNavigationMode
  Xaml_Input_KeyboardNavigationMode = (
    Local = 0,
    Cycle = 1,
    Once = 2
  );
  PXaml_Input_KeyboardNavigationMode = ^Xaml_Input_KeyboardNavigationMode;

  // Windows.UI.Xaml.Input.ManipulationModes
  Xaml_Input_ManipulationModes = (
    None = 0,
    TranslateX = 1,
    TranslateY = 2,
    TranslateRailsX = 4,
  ...
  PXaml_Input_ManipulationModes = ^Xaml_Input_ManipulationModes;

  // Windows.UI.Xaml.Media.Imaging.BitmapCreateOptions
  Xaml_Media_Imaging_BitmapCreateOptions = (
    None = 0,
    IgnoreImageCache = 8
  );
  PXaml_Media_Imaging_BitmapCreateOptions = ^Xaml_Media_Imaging_BitmapCreateOptions;

  // Windows.UI.Xaml.Media.Imaging.DecodePixelType
  Xaml_Media_Imaging_DecodePixelType = (
    Physical = 0,
    Logical = 1
  );
  PXaml_Media_Imaging_DecodePixelType = ^Xaml_Media_Imaging_DecodePixelType;

  // Windows.UI.Xaml.Controls.Primitives.AnimationDirection
  Xaml_Controls_Primitives_AnimationDirection = (
    Left = 0,
    Top = 1,
    Right = 2,
    Bottom = 3
  );
  PXaml_Controls_Primitives_AnimationDirection = ^Xaml_Controls_Primitives_AnimationDirection;

  // Windows.UI.Xaml.Controls.Primitives.ComponentResourceLocation
  Xaml_Controls_Primitives_ComponentResourceLocation = (
    Application = 0,
    Nested = 1
  );
  PXaml_Controls_Primitives_ComponentResourceLocation = ^Xaml_Controls_Primitives_ComponentResourceLocation;

  // Windows.UI.Xaml.Controls.Primitives.EdgeTransitionLocation
  Xaml_Controls_Primitives_EdgeTransitionLocation = (
    Left = 0,
    Top = 1,
    Right = 2,
    Bottom = 3
  );
  PXaml_Controls_Primitives_EdgeTransitionLocation = ^Xaml_Controls_Primitives_EdgeTransitionLocation;

  // Windows.UI.Xaml.Controls.Primitives.FlyoutPlacementMode
  Xaml_Controls_Primitives_FlyoutPlacementMode = (
    Top = 0,
    Bottom = 1,
    Left = 2,
    Right = 3,
  ...
  PXaml_Controls_Primitives_FlyoutPlacementMode = ^Xaml_Controls_Primitives_FlyoutPlacementMode;

  // Windows.UI.Xaml.Automation.AnnotationType
  Xaml_Automation_AnnotationType = (
    Unknown = 60000,
    SpellingError = 60001,
    GrammarError = 60002,
    Comment = 60003,
  ...
  PXaml_Automation_AnnotationType = ^Xaml_Automation_AnnotationType;

  // Windows.UI.Xaml.Automation.AutomationTextEditChangeType
  Xaml_Automation_AutomationTextEditChangeType = (
    None = 0,
    AutoCorrect = 1,
    Composition = 2,
    CompositionFinalized = 3
  );
  PXaml_Automation_AutomationTextEditChangeType = ^Xaml_Automation_AutomationTextEditChangeType;

  // Windows.UI.Xaml.Automation.DockPosition
  Xaml_Automation_DockPosition = (
    Top = 0,
    Left = 1,
    Bottom = 2,
    Right = 3,
  ...
  PXaml_Automation_DockPosition = ^Xaml_Automation_DockPosition;

  // Windows.UI.Xaml.Automation.ExpandCollapseState
  Xaml_Automation_ExpandCollapseState = (
    Collapsed = 0,
    Expanded = 1,
    PartiallyExpanded = 2,
    LeafNode = 3
  );
  PXaml_Automation_ExpandCollapseState = ^Xaml_Automation_ExpandCollapseState;

  // Windows.UI.Xaml.Automation.RowOrColumnMajor
  Xaml_Automation_RowOrColumnMajor = (
    RowMajor = 0,
    ColumnMajor = 1,
    Indeterminate = 2
  );
  PXaml_Automation_RowOrColumnMajor = ^Xaml_Automation_RowOrColumnMajor;

  // Windows.UI.Xaml.Automation.ScrollAmount
  Xaml_Automation_ScrollAmount = (
    LargeDecrement = 0,
    SmallDecrement = 1,
    NoAmount = 2,
    LargeIncrement = 3,
  ...
  PXaml_Automation_ScrollAmount = ^Xaml_Automation_ScrollAmount;

  // Windows.UI.Xaml.Automation.SupportedTextSelection
  Xaml_Automation_SupportedTextSelection = (
    None = 0,
    Single = 1,
    Multiple = 2
  );
  PXaml_Automation_SupportedTextSelection = ^Xaml_Automation_SupportedTextSelection;

  // Windows.UI.Xaml.Automation.SynchronizedInputType
  Xaml_Automation_SynchronizedInputType = (
    KeyUp = 1,
    KeyDown = 2,
    LeftMouseUp = 4,
    LeftMouseDown = 8,
  ...
  PXaml_Automation_SynchronizedInputType = ^Xaml_Automation_SynchronizedInputType;

  // Windows.UI.Xaml.Automation.ToggleState
  Xaml_Automation_ToggleState = (
    Off = 0,
    On = 1,
    Indeterminate = 2
  );
  PXaml_Automation_ToggleState = ^Xaml_Automation_ToggleState;

  // Windows.UI.Xaml.Automation.WindowInteractionState
  Xaml_Automation_WindowInteractionState = (
    Running = 0,
    Closing = 1,
  ...
  PXaml_Automation_WindowInteractionState = ^Xaml_Automation_WindowInteractionState;

  // Windows.UI.Xaml.Automation.WindowVisualState
  Xaml_Automation_WindowVisualState = (
    Normal = 0,
    Maximized = 1,
    Minimized = 2
  );
  PXaml_Automation_WindowVisualState = ^Xaml_Automation_WindowVisualState;

  // Windows.UI.Xaml.Automation.ZoomUnit
  Xaml_Automation_ZoomUnit = (
    NoAmount = 0,
    LargeDecrement = 1,
    SmallDecrement = 2,
    LargeIncrement = 3,
  ...
  PXaml_Automation_ZoomUnit = ^Xaml_Automation_ZoomUnit;

  // Windows.UI.Xaml.Automation.Peers.AccessibilityView
  Xaml_Automation_Peers_AccessibilityView = (
    Raw = 0,
    Control = 1,
    Content = 2
  );
  PXaml_Automation_Peers_AccessibilityView = ^Xaml_Automation_Peers_AccessibilityView;

  // Windows.UI.Xaml.Automation.Peers.AutomationControlType
  Xaml_Automation_Peers_AutomationControlType = (
    Button = 0,
    Calendar = 1,
    CheckBox = 2,
    ComboBox = 3,
  ...
  PXaml_Automation_Peers_AutomationControlType = ^Xaml_Automation_Peers_AutomationControlType;

  // Windows.UI.Xaml.Automation.Peers.AutomationEvents
  Xaml_Automation_Peers_AutomationEvents = (
    ToolTipOpened = 0,
    ToolTipClosed = 1,
    MenuOpened = 2,
    MenuClosed = 3,
  ...
  PXaml_Automation_Peers_AutomationEvents = ^Xaml_Automation_Peers_AutomationEvents;

  // Windows.UI.Xaml.Automation.Peers.AutomationLiveSetting
  Xaml_Automation_Peers_AutomationLiveSetting = (
    Off = 0,
    Polite = 1,
    Assertive = 2
  );
  PXaml_Automation_Peers_AutomationLiveSetting = ^Xaml_Automation_Peers_AutomationLiveSetting;

  // Windows.UI.Xaml.Automation.Peers.AutomationNavigationDirection
  Xaml_Automation_Peers_AutomationNavigationDirection = (
    Parent = 0,
    NextSibling = 1,
    PreviousSibling = 2,
    FirstChild = 3,
  ...
  PXaml_Automation_Peers_AutomationNavigationDirection = ^Xaml_Automation_Peers_AutomationNavigationDirection;

  // Windows.UI.Xaml.Automation.Peers.AutomationOrientation
  Xaml_Automation_Peers_AutomationOrientation = (
    None = 0,
    Horizontal = 1,
    Vertical = 2
  );
  PXaml_Automation_Peers_AutomationOrientation = ^Xaml_Automation_Peers_AutomationOrientation;

  // Windows.UI.Xaml.Automation.Peers.AutomationStructureChangeType
  Xaml_Automation_Peers_AutomationStructureChangeType = (
    ChildAdded = 0,
    ChildRemoved = 1,
  ...
  PXaml_Automation_Peers_AutomationStructureChangeType = ^Xaml_Automation_Peers_AutomationStructureChangeType;

  // Windows.UI.Xaml.Automation.Peers.PatternInterface
  Xaml_Automation_Peers_PatternInterface = (
    Invoke = 0,
    Selection = 1,
    Value = 2,
    RangeValue = 3,
  ...
  PXaml_Automation_Peers_PatternInterface = ^Xaml_Automation_Peers_PatternInterface;

  // Windows.UI.Xaml.Automation.Text.TextPatternRangeEndpoint
  Xaml_Automation_Text_TextPatternRangeEndpoint = (
    Start = 0,
    &End = 1
  );
  PXaml_Automation_Text_TextPatternRangeEndpoint = ^Xaml_Automation_Text_TextPatternRangeEndpoint;

  // Windows.UI.Xaml.Automation.Text.TextUnit
  Xaml_Automation_Text_TextUnit = (
    Character = 0,
    Format = 1,
    Word = 2,
    Line = 3,
  ...
  PXaml_Automation_Text_TextUnit = ^Xaml_Automation_Text_TextUnit;

  // Windows.UI.Xaml.Data.BindingMode
  Xaml_Data_BindingMode = (
    OneWay = 1,
    OneTime = 2,
    TwoWay = 3
  );
  PXaml_Data_BindingMode = ^Xaml_Data_BindingMode;

  // Windows.UI.Xaml.Data.RelativeSourceMode
  Xaml_Data_RelativeSourceMode = (
    None = 0,
    TemplatedParent = 1,
    Self = 2
  );
  PXaml_Data_RelativeSourceMode = ^Xaml_Data_RelativeSourceMode;

  // Windows.UI.Xaml.Data.UpdateSourceTrigger
  Xaml_Data_UpdateSourceTrigger = (
    Default = 0,
    PropertyChanged = 1,
    Explicit = 2
  );
  PXaml_Data_UpdateSourceTrigger = ^Xaml_Data_UpdateSourceTrigger;

  // Windows.UI.Xaml.Interop.TypeKind
  Xaml_Interop_TypeKind = (
    Primitive = 0,
    Metadata = 1,
    Custom = 2
  );
  PXaml_Interop_TypeKind = ^Xaml_Interop_TypeKind;

  // Windows.UI.Xaml.AutomationTextAttributesEnum
  Xaml_AutomationTextAttributesEnum = (
  ...
  PXaml_AutomationTextAttributesEnum = ^Xaml_AutomationTextAttributesEnum;

  // Windows.UI.Xaml.Automation.AutomationActiveEnd
  Xaml_Automation_AutomationActiveEnd = (
    None = 0,
    Start = 1,
    &End = 2
  );
  PXaml_Automation_AutomationActiveEnd = ^Xaml_Automation_AutomationActiveEnd;

  // Windows.UI.Xaml.Automation.AutomationAnimationStyle
  Xaml_Automation_AutomationAnimationStyle = (
    None = 0,
    LasVegasLights = 1,
  ...
  PXaml_Automation_AutomationAnimationStyle = ^Xaml_Automation_AutomationAnimationStyle;

  // Windows.UI.Xaml.Automation.AutomationBulletStyle
  Xaml_Automation_AutomationBulletStyle = (
    None = 0,
    HollowRoundBullet = 1,
    FilledRoundBullet = 2,
  ...
  PXaml_Automation_AutomationBulletStyle = ^Xaml_Automation_AutomationBulletStyle;

  // Windows.UI.Xaml.Automation.AutomationCaretBidiMode
  Xaml_Automation_AutomationCaretBidiMode = (
    LTR = 0,
    RTL = 1
  );
  PXaml_Automation_AutomationCaretBidiMode = ^Xaml_Automation_AutomationCaretBidiMode;

  // Windows.UI.Xaml.Automation.AutomationCaretPosition
  Xaml_Automation_AutomationCaretPosition = (
    Unknown = 0,
    EndOfLine = 1,
    BeginningOfLine = 2
  );
  PXaml_Automation_AutomationCaretPosition = ^Xaml_Automation_AutomationCaretPosition;

  // Windows.UI.Xaml.Automation.AutomationFlowDirections
  Xaml_Automation_AutomationFlowDirections = (
    Default = 0,
    RightToLeft = 1,
    BottomToTop = 2,
    Vertical = 3
  );
  PXaml_Automation_AutomationFlowDirections = ^Xaml_Automation_AutomationFlowDirections;

  // Windows.UI.Xaml.Automation.AutomationOutlineStyles
  Xaml_Automation_AutomationOutlineStyles = (
    None = 0,
    Outline = 1,
    Shadow = 2,
    Engraved = 3,
  ...
  PXaml_Automation_AutomationOutlineStyles = ^Xaml_Automation_AutomationOutlineStyles;

  // Windows.UI.Xaml.Automation.AutomationStyleId
  Xaml_Automation_AutomationStyleId = (
    Heading1 = 70001,
    Heading2 = 70002,
    Heading3 = 70003,
    Heading4 = 70004,
  ...
  PXaml_Automation_AutomationStyleId = ^Xaml_Automation_AutomationStyleId;

  // Windows.UI.Xaml.Automation.AutomationTextDecorationLineStyle
  Xaml_Automation_AutomationTextDecorationLineStyle = (
    None = 0,
    Single = 1,
    WordsOnly = 2,
    Double = 3,
  ...
  PXaml_Automation_AutomationTextDecorationLineStyle = ^Xaml_Automation_AutomationTextDecorationLineStyle;

  // Windows.UI.Xaml.Controls.Maps.MapAnimationKind
  Xaml_Controls_Maps_MapAnimationKind = (
    Default = 0,
    None = 1,
    Linear = 2,
    Bow = 3
  );
  PXaml_Controls_Maps_MapAnimationKind = ^Xaml_Controls_Maps_MapAnimationKind;

  // Windows.UI.Xaml.Controls.Maps.MapColorScheme
  Xaml_Controls_Maps_MapColorScheme = (
    Light = 0,
    Dark = 1
  );
  PXaml_Controls_Maps_MapColorScheme = ^Xaml_Controls_Maps_MapColorScheme;

  // Windows.UI.Xaml.Controls.Maps.MapElementCollisionBehavior
  Xaml_Controls_Maps_MapElementCollisionBehavior = (
    Hide = 0,
    RemainVisible = 1
  );
  PXaml_Controls_Maps_MapElementCollisionBehavior = ^Xaml_Controls_Maps_MapElementCollisionBehavior;

  // Windows.UI.Xaml.Controls.Maps.MapInteractionMode
  Xaml_Controls_Maps_MapInteractionMode = (
    Auto = 0,
    Disabled = 1,
    GestureOnly = 2,
    ControlOnly = 3,
  ...
  PXaml_Controls_Maps_MapInteractionMode = ^Xaml_Controls_Maps_MapInteractionMode;

  // Windows.UI.Xaml.Controls.Maps.MapLoadingStatus
  Xaml_Controls_Maps_MapLoadingStatus = (
    Loading = 0,
    Loaded = 1
  );
  PXaml_Controls_Maps_MapLoadingStatus = ^Xaml_Controls_Maps_MapLoadingStatus;

  // Windows.UI.Xaml.Controls.Maps.MapPanInteractionMode
  Xaml_Controls_Maps_MapPanInteractionMode = (
    Auto = 0,
    Disabled = 1
  );
  PXaml_Controls_Maps_MapPanInteractionMode = ^Xaml_Controls_Maps_MapPanInteractionMode;

  // Windows.UI.Xaml.Controls.Maps.MapStyle
  Xaml_Controls_Maps_MapStyle = (
    None = 0,
    Road = 1,
    Aerial = 2,
    AerialWithRoads = 3,
  ...
  PXaml_Controls_Maps_MapStyle = ^Xaml_Controls_Maps_MapStyle;

  // Windows.UI.Xaml.Controls.Maps.MapTileLayer
  Xaml_Controls_Maps_MapTileLayer = (
    LabelOverlay = 0,
    RoadOverlay = 1,
    AreaOverlay = 2,
    BackgroundOverlay = 3,
  ...
  PXaml_Controls_Maps_MapTileLayer = ^Xaml_Controls_Maps_MapTileLayer;

  // Windows.UI.Xaml.Controls.Maps.MapWatermarkMode
  Xaml_Controls_Maps_MapWatermarkMode = (
    Automatic = 0,
    On = 1
  );
  PXaml_Controls_Maps_MapWatermarkMode = ^Xaml_Controls_Maps_MapWatermarkMode;

  // Windows.UI.Xaml.Controls.ListPickerFlyoutSelectionMode
  Xaml_Controls_ListPickerFlyoutSelectionMode = (
    Single = 0,
    Multiple = 1
  );
  PXaml_Controls_ListPickerFlyoutSelectionMode = ^Xaml_Controls_ListPickerFlyoutSelectionMode;

  // Windows.UI.Xaml.Controls.PivotSlideInAnimationGroup
  Xaml_Controls_PivotSlideInAnimationGroup = (
    Default = 0,
    GroupOne = 1,
    GroupTwo = 2,
    GroupThree = 3
  );
  PXaml_Controls_PivotSlideInAnimationGroup = ^Xaml_Controls_PivotSlideInAnimationGroup;



  // Windows.UI.xaml Records
  // Windows.UI.Xaml.CornerRadius
  Xaml_CornerRadius = record
    TopLeft: Double;
    TopRight: Double;
    BottomRight: Double;
    BottomLeft: Double;
  end;
  PXaml_CornerRadius = ^Xaml_CornerRadius;

  // Windows.UI.Xaml.Duration
  Xaml_Duration = record
    TimeSpan: TimeSpan;
    &Type: Xaml_DurationType;
  end;
  PXaml_Duration = ^Xaml_Duration;

  // Windows.UI.Xaml.GridLength
  Xaml_GridLength = record
    Value: Double;
    GridUnitType: Xaml_GridUnitType;
  end;
  PXaml_GridLength = ^Xaml_GridLength;

  // Windows.UI.Xaml.Thickness
  Xaml_Thickness = record
    Left: Double;
    Top: Double;
    Right: Double;
    Bottom: Double;
  end;
  PXaml_Thickness = ^Xaml_Thickness;

  // Windows.UI.Xaml.Media.Matrix
  Xaml_Media_Matrix = record
    M11: Double;
    M12: Double;
    M21: Double;
    M22: Double;
  ...
  PXaml_Media_Matrix = ^Xaml_Media_Matrix;

  // Windows.UI.Xaml.Media.Animation.KeyTime
  Xaml_Media_Animation_KeyTime = record
    TimeSpan: TimeSpan;
  end;
  PXaml_Media_Animation_KeyTime = ^Xaml_Media_Animation_KeyTime;

  // Windows.UI.Xaml.Media.Animation.RepeatBehavior
  Xaml_Media_Animation_RepeatBehavior = record
    Count: Double;
    Duration: TimeSpan;
    &Type: Xaml_Media_Animation_RepeatBehaviorType;
  end;
  PXaml_Media_Animation_RepeatBehavior = ^Xaml_Media_Animation_RepeatBehavior;

  // Windows.UI.Xaml.Controls.Primitives.GeneratorPosition
  Xaml_Controls_Primitives_GeneratorPosition = record
    Index: Integer;
    Offset: Integer;
  end;
  PXaml_Controls_Primitives_GeneratorPosition = ^Xaml_Controls_Primitives_GeneratorPosition;

  // Windows.UI.Xaml.Automation.Peers.RawElementProviderRuntimeId
  Xaml_Automation_Peers_RawElementProviderRuntimeId = record
    Part1: Cardinal;
    Part2: Cardinal;
  end;
  PXaml_Automation_Peers_RawElementProviderRuntimeId = ^Xaml_Automation_Peers_RawElementProviderRuntimeId;

  // Windows.UI.Xaml.Data.LoadMoreItemsResult
  Xaml_Data_LoadMoreItemsResult = record
    Count: Cardinal;
  end;
  PXaml_Data_LoadMoreItemsResult = ^Xaml_Data_LoadMoreItemsResult;

  // Windows.UI.Xaml.Media.Media3D.Matrix3D
  Xaml_Media_Media3D_Matrix3D = record
    M11: Double;
    M12: Double;
    M13: Double;
    M14: Double;
  ...
  PXaml_Media_Media3D_Matrix3D = ^Xaml_Media_Media3D_Matrix3D;

  // Windows.UI.Xaml.Markup.XamlBinaryWriterErrorInformation
  Xaml_Markup_XamlBinaryWriterErrorInformation = record
    InputStreamIndex: Cardinal;
    LineNumber: Cardinal;
    LinePosition: Cardinal;
  end;
  PXaml_Markup_XamlBinaryWriterErrorInformation = ^Xaml_Markup_XamlBinaryWriterErrorInformation;

  // Windows.UI.Xaml.Markup.XmlnsDefinition
  Xaml_Markup_XmlnsDefinition = record
    XmlNamespace: HSTRING;
    Namespace: HSTRING;
  end;
  PXaml_Markup_XmlnsDefinition = ^Xaml_Markup_XmlnsDefinition;

  // Windows.UI.Xaml.Interop.TypeName
  Xaml_Interop_TypeName = record
    Name: HSTRING;
    Kind: Xaml_Interop_TypeKind;
  end;
  PXaml_Interop_TypeName = ^Xaml_Interop_TypeName;

  // Windows.UI.Xaml.Controls.Maps.MapZoomLevelRange
  Xaml_Controls_Maps_MapZoomLevelRange = record
    Min: Double;
    Max: Double;
  end;
  PXaml_Controls_Maps_MapZoomLevelRange = ^Xaml_Controls_Maps_MapZoomLevelRange;

  // Windows.UI.Xaml.Hosting.HostingContract
  Xaml_Hosting_HostingContract = record
  end;
  PXaml_Hosting_HostingContract = ^Xaml_Hosting_HostingContract;
