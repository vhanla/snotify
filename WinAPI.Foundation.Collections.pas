...
type
  ...
  ['{5DB5FA32-707C-5849-A06B-91C8EB9D10E8}']
    ...
    function GetMany(out {TODO: verify}items: PIKeyValuePair_2__HSTRING__IInspectable): Cardinal; safecall;
  ...
  ['{8C304EBB-6615-50A4-8829-879ECD443236}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PHSTRING): Cardinal; safecall;
  ...
  ['{2F13C006-A03A-5F69-B090-75A43E33423E}']
    ...
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PHSTRING): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{98B9ACC1-4B56-532E-AC73-03D5291CCA90}']
    ...
    procedure Clear; safecall;
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PHSTRING): Cardinal; safecall;
    procedure ReplaceAll({TODO: verify}items: PHSTRING); safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{4F25059A-0B9A-5F25-9B9E-4B9F1D22FF65}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PIKeyValuePair_2__TGuid__IInspectable): Cardinal; safecall;
  ...
  ['{BFEA7F78-50C2-5F1D-A6EA-9E978D2699FF}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PInteger): Cardinal; safecall;
  ...
  ['{8D720CDF-3934-5D3F-9A55-40E8063B086A}']
    ...
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PInteger): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{B939AF5B-B45D-5489-9149-61442C1905FE}']
    ...
    procedure Clear; safecall;
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PInteger): Cardinal; safecall;
    procedure ReplaceAll({TODO: verify}items: PInteger); safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{05EB86F1-7140-5517-B88D-CBAEBE57E6B1}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PIKeyValuePair_2__HSTRING__HSTRING): Cardinal; safecall;
  ...
  ['{643B6D83-457E-5A43-800F-B0449F91D96B}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PIKeyValuePair_2__HSTRING__IVectorView_1__HSTRING): Cardinal; safecall;
  ...
  ['{D3D64048-82B3-53C7-9285-B0BE18368482}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PGuid): Cardinal; safecall;
  ...
  ['{9520E64B-15B2-52A6-98ED-3191FA6CF68A}']
    ...
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PGuid): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{482E676D-B913-5EC1-AFA8-5F96922E94AE}']
    ...
    procedure Clear; safecall;
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PGuid): Cardinal; safecall;
    procedure ReplaceAll({TODO: verify}items: PGuid); safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{F06A2739-9443-5EF0-B284-DC5AFF3E7D10}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PCardinal): Cardinal; safecall;
  ...
  ['{E5CE1A07-8D33-5007-BA64-7D2508CCF85C}']
    ...
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PCardinal): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  {
  // Used Types:  Void
  // Used Types:  Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IPropertySet>
  ...
  ['{44A94F2D-04F8-5091-B336-BE7892DD10BE}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PIInspectable): Cardinal; safecall;
  ...
  ['{A6487363-B074-5C60-AB16-866DCE4EE54D}']
    ...
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PIInspectable): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{40556131-A2A1-5FAB-AAEE-5F35268CA26B}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PByte): Cardinal; safecall;
  ...
  ['{6D05FB29-7885-544E-9382-A1AD391A3FA4}']
    ...
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PByte): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{53A2E825-9BF1-5083-8A7B-9D94F312DADE}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PIMapView_2__HSTRING__IInspectable): Cardinal; safecall;
  ...
  ['{172A655B-B3B8-5EAE-BC2E-A6A1F1708B4B}']
    ...
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PIMapView_2__HSTRING__IInspectable): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{A11824C9-E458-502A-AFD8-CE3CE0ABD6FE}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PIKeyValuePair_2__HSTRING__IVector_1__HSTRING): Cardinal; safecall;
  ...
  ['{B32BDCA4-5E52-5B27-BC5D-D66A1A268C2A}']
    ...
    procedure Clear; safecall;
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PIInspectable): Cardinal; safecall;
    procedure ReplaceAll({TODO: verify}items: PIInspectable); safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{31E55E8A-0F05-52FD-90D3-B04AA331AAA4}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PIKeyValuePair_2__IInspectable__IInspectable): Cardinal; safecall;
  ...
  ['{42614E61-B0AA-5E72-9354-2771DB20B7A8}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PSingle): Cardinal; safecall;
  ...
  ['{7BCA64FD-150C-5D50-B56B-9F4F474C5930}']
    ...
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PSingle): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{61CF693F-DB4C-579F-B905-5DD3D23CFD4D}']
    ...
    procedure Clear; safecall;
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PSingle): Cardinal; safecall;
    procedure ReplaceAll({TODO: verify}items: PSingle); safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{638A2CF4-F474-5318-9055-141CB909AC4B}']
    ...
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(out {TODO: verify}items: PDouble): Cardinal; safecall;
  ...
  ['{AF7586A8-6B21-5F61-BFF1-1B682293AD96}']
    ...
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PDouble): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  ['{F452D23C-BF05-5F3E-88E7-D17A6716B911}']
    ...
    procedure Clear; safecall;
    function GetMany(startIndex: Cardinal; out {TODO: verify}items: PDouble): Cardinal; safecall;
    procedure ReplaceAll({TODO: verify}items: PDouble); safecall;
    property Size: Cardinal read get_Size;
  end;
